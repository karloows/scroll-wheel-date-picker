...
0. Check `git branch --show-current` FIRST. If it's the base branch (`main`), you MUST create and switch to the feature branch before touching `git add` or `git commit` — never commit on the base branch, even temporarily.
